...
export const heroActionFields = () => [
  ...
  defineField({
    ...
    type: 'string',
    description: 'Bouton plein blanc (sur hero sombre). Obligatoire pour les modes avec bouton. « Télécharge l’app » ouvre l’App Store.',
  ...
  defineField({
    ...
    type: 'string',
    description: 'Pour « Télécharge l’app », n’importe quel lien suffit : le site ouvre https://apps.apple.com/fr/app/segna/id6799780391.',
    hidden: ({parent}) => !layoutUsesPrimaryCta(parent?.heroActionLayout),
